  ...
  const services = [
    {
      ...
      description: 'Уютный номер, 3-х разовое питание, прогулки 2 раза в день',
      icon: 'Home',
      price: '1 200₽',
      period: 'в сутки',
      features: ['Отдельная комната', 'Удобная лежанка', 'Игрушки']
    },
    {
      title: 'Проживание Люкс',
      description: 'Просторный номер с кондиционером, 4-х разовое питание',
      icon: 'Star',
      price: '1 800₽',
      period: 'в сутки',
      features: ['Кондиционер', 'Мягкая мебель', 'Частые прогулки', 'Видео в номере']
    },
    {
